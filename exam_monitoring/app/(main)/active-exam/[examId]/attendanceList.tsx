        ...
        {attendance.map(record => (
          ...
          >
            ...
            <div className="flex gap-2 pt-2">
              ...
              <button
                disabled={record.attendanceStatus === "finished" || record.attendanceStatus === "transferred"}
                onClick={() => {setSelectedRecord(record); setOpenTransfer(true);}}
                className="flex-1 rounded-xl px-3 py-2 text-xs font-semibold text-white bg-[var(--purple)] disabled:bg-[var(--border)]
