    ...
    return(
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            ...
            <div className="my-4 space-y-4">
                ...
                <select className="w-full border rounded p-2 text-black" value={eventType} onChange={(e) => setEventType(e.target.value)}>
                ...
                <div className="flex justify-end gap-2">
                    <button className="border px-4 py-2 rounded" onClick={onClose}>ביטול</button>
