        ...
        <nav className="flex items-center justify-between bg-[#1b2430] py-5 px-20 shadow-[0_5px_15px_rgba(0,0,0,0.06)]">
            ...
            <div>
                <ul className="flex items-center justify-center">
                    <li className="list-none px-5 relative"><a href="index.html" className="no-underline text-[1.3rem] font-semibold text-white transition duration-300 ease-in-out hover:text-[#17cf97] hover:after:content-[''] 
